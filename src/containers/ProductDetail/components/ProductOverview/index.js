        ...
        <div className="productOverview">
          <div className="productOverview__header">
            ...
            <div className="productOverview__baseInfo">
              ...
              <div className="productOverview__content">{data.product}</div>
            </div>
          </div>

          <div className="productVOerview__purchase">
          ...
          <ul className="productOverview__remark">
            <li className="productOverview__remarkItem">
              ...
              <span className="productOverview__des">随时可退</span>
            </li>
            <li className="productOverview__remarkItem">
              <i className="productOverview__sign2"></i>
              <span className="productOverview__des">过期自动退</span>
            </li>
          </ul>
        </div>
      </div>
